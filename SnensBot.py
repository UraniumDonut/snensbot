...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith("!help"):
            ...
            embed_help.add_field(name="!now", value="Gibt die aktuelle Stunde mit Zoomlink und Infos zum Fach zurück", inline=False)
            embed_help.add_field(name="!Fach \"spezielles Fach\" ", value="Gibt das ausgewählte Fach mit Infos zurück", inline=False)
            embed_help.add_field(name="reagiere mit :poop:", value="und es wird durch THAT'S CRINGE ersetzt", inline=False)
